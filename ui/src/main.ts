// Standalone development entry: mounts the ticket routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'ticket (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())

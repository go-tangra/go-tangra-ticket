...
//		GroupBy(ticketcomment.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.TicketComment.Query().
//		Select(ticketcomment.FieldCreateTime).
//		Scan(ctx, &v)
...
func (_q *TicketCommentQuery) prepareQuery(ctx context.Context) error {
	...
	if ticketcomment.Policy == nil {
		return errors.New("ent: uninitialized ticketcomment.Policy (forgotten import ent/runtime?)")
	}
	if err := ticketcomment.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *TicketCommentQuery) Modify(modifiers ...func(s *sql.Selector)) *TicketCommentSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *TicketCommentSelect) Modify(modifiers ...func(s *sql.Selector)) *TicketCommentSelect {
